...
hi StatusLine           cterm=none ctermbg=0        ctermfg=7       gui=none        guibg=#5D5D5D   guifg=#FBFBFB
hi StatusLineNC         cterm=none ctermbg=238      ctermfg=7       gui=none        guibg=#5D5D5D   guifg=#FBFBFB
hi Search               cterm=none ctermbg=6        ctermfg=15      gui=none        guibg=#2EB5C1   guifg=#F7F7F7
hi IncSearch            cterm=none ctermbg=3        ctermfg=0       gui=none        guibg=#F6DC69   guifg=#8F8F8F
...
hi Folded               cterm=none ctermbg=238      ctermfg=2       gui=none        guibg=#3B3B3B   guifg=#90AB41
...
hi MatchParen           cterm=none ctermbg=14       ctermfg=15      gui=none        guibg=#2EB5C1   guifg=#F7F7F7
hi CursorLine           cterm=none ctermbg=0        ctermfg=none    gui=none        guibg=#424242
hi CursorColumn         cterm=none ctermbg=8        ctermfg=none    gui=none        guibg=#424242
hi Title                cterm=none ctermbg=none     ctermfg=4       gui=none                        guifg=#88CCE7
hi VertSplit            cterm=bold ctermbg=none     ctermfg=1       gui=bold        guibg=#282828   guifg=#8F8F8F
